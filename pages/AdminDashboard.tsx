...
export const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-gray-100 overflow-hidden relative text-slate-900">
      ...
      <aside
        className={`absolute md:static inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 flex flex-col transition-transform duration-300 transform ${
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-10 w-full custom-scrollbar">
        <button
          ...
          className="md:hidden p-3 bg-white rounded-xl shadow-sm mb-6 border"
        >
          <Menu size={20} />
        </button>
